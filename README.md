...
- Note: Will be depreciated when the database team finishes their work
...
## Cluster Summaries 
- Python script that reviews the clusters made and provides aggregation values (avg, min, max) 
- Produces 2 new JSON files for the summaries of each anchor point 
